...
export default function Welcome(props) {
    return (
        <>
            <Head title="Welcome" />
            <div style={{backgroundImage: `url(/assets/images/cover2.jpg)`}} className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
